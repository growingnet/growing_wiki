...
Net2Net :raw-latex:`\cite{chen_net2net_2016}` proposed a *Net2WiderNet*
...
known as *Net2DeeperNet* :raw-latex:`\cite{chen_net2net_2016}`. In
...
activation functions :raw-latex:`\cite{wei_network_2016}`.
